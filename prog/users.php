...
<div id="users" style=" height:85%; display:none; overflow-y:scroll;">
    <div>

        <div style="float: left; min-width: 190px; margin-right: 100px;">
        ...
        <div style="float: left; min-width: 800px;">
            <div style="border-bottom: solid #dae1e9 1px; padding-bottom: 7px; margin-bottom: 3px;">
                ...
                <div style="float:right">
                    <input type="button" class="btn btn-primary btn-xs" value="Create" id="btn-user-create" />
                </div>
            </div>
            ...
            <div>
                ...
                <div style="float:left; min-width: 97px; padding: 0 0 0 5px;">
                    <div style="margin: 5px 0 4px 0;">First Name<input type="text" class="form-control" value="" id="user-firstname" /></div>
                    <div style="margin: 5px 0 4px 0;">Last Name<input type="text" class="form-control" value="" id="user-lastname" /></div>
                    <div style="margin: 5px 0 4px 0;">Age<input type="text" class="form-control" value="" id="user-age" /></div>
                    <div style="margin: 5px 0 4px 0;">Current Address<input type="text" class="form-control" value="" id="user-address" /></div>
                    <div style="margin: 5px 0 4px 0;">Officer Position<input type="text" class="form-control" value="" id="user-position" /></div>
                    <div style="margin: 5px 0 4px 0;">Officer ID Number<input type="text" class="form-control" value="" id="user-id-number" /></div>
                    <div style="margin: 5px 0 4px 0;">Username<input type="text" class="form-control" value="" id="user-username" /></div>
                    <div style="margin: 5px 0 4px 0;">Password<input type="password" class="form-control" value="" id="user-password" /></div>
					<div style="margin: 5px 0 4px 0;">Confirm Password<input type="password" class="form-control" value="" id="user-password-confirmation" /></div>
                    <div style="margin: 5px 0 4px 0;">Date Registered<input type="text" size="25" style="margin: 0;" tabindex="1" disabled="disabled" value="" id="user-registration" /></div>
                    <div style="margin: 5px 0 4px 0;"><input type="checkbox" value="0" id="user-is-admin" />Is Admin</div>
                    <div style="margin: 5px 0 4px 0;">
                        <input type="button" class="btn btn-primary" value="dtr" id="btn-dtr-user" style="display:none; float: left; " />&nbsp;
                        <input type="button" class="btn btn-primary" value="update" id="btn-user-update" style="float: left; " />
                        <input type="button" class="btn btn-primary" value="save" id="btn-user-save" style="display:none; float: left; " />
                    </div>
        ...
        $.ajax({
            ...
            $.each(data, function (i, e) {
                var html = "<div style=\"height: 30px;\">" +
                                ...
                                "<div style='margin-bottom: 10px; float:right; cursor:pointer;' id='delete_user_" + e.id + "'>" + '<b>Remove user</b>' + "</div>" +
                           "</div>";
